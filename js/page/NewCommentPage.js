...
export default class NewCommentPage extends Component{
    ...
    constructor(props){
        ...
        this.state = {
            ...
            postId:navigation.getParam('postId', '1'), //动态获取barId
            pictureList:[],
            pending: false,
        };
        ...
        return(
            <View>
                ...
                <Flex style={styles.inputContainer}>
                    ...
                    />
                    <Text style={(this.state.text.length > 1 || this.state.pictureList.length >0 ) && !this.state.pending ? styles.inputSubmitYes:styles.inputSubmitNo}
                        onPress={(this.state.text.length > 1 || this.state.pictureList.length >0 ) ? this._sendMessage:()=>{}}
                    >发布</Text>
                </Flex>
                <View>
    ...
    _sendMessage =() => {
        ...
        axios.put(url,
            ...
            if(response.data.code == 0){
                ...
                //this._onRefresh();
                this.props.navigation.navigate('PostPage', {barId: this.state.barId,postId: this.state.postId})
            }else{
